...
import os
import time
import shutil  # ✅ নতুন: ব্যাকআপ নেয়ার জন্য

SHOPS_FILE = 'shops.json'
BACKUP_FILE = 'shops.json.bak' # ✅ নতুন: ব্যাকআপ ফাইলের নাম
...
def load_shops():
    """
    নিরাপদভাবে ডাটা লোড করে। ফাইল নষ্ট থাকলে .corrupt নামে রিনেম করে,
    ...
    if os.path.exists(SHOPS_FILE):
        try:
            ...
            # ✅ ফিক্স: যদি জেসন ফাইল নষ্ট হয়, তবে সেটি ব্যাকআপ করে রাখা হবে
...
def save_shops(data):
    """
    ডাটা সেভ করার আগে অটোমেটিক ব্যাকআপ তৈরি করে।
    """
    # ✅ ফিক্স: সেভ করার আগে আগের ফাইলের ব্যাকআপ নেওয়া
    if os.path.exists(SHOPS_FILE):
        try:
